...
#        )
        ...
        await query.answer("❤️ A Big Thank To All Contributors For Making This Bot Awesome!🎁🎪\n\n 𝐌𝐀𝐃𝐄 𝐁𝐘 - 𝘽𝙃𝙐𝙈𝙄𝙃𝘼𝙍", show_alert=True)
 
    elif query.data == "source":
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://telegram.me/Thebhumihar')
        ],[
