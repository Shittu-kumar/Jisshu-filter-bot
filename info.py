...
BOT_TOKEN = environ.get('BOT_TOKEN', '7552493941:AAH4O6o_jNK04KMwZpm4cceLLYeHxK3i8WA')
...
# MongoDB 
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Demo23:Demo23@cluster0.4lbngfz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002676199651') 
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002676199651')) 

# Added Link Here Not Id 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+xLVaNLxvCCBlNmVl')
...
SHORTENER_API = environ.get("SHORTENER_API", "bf2841e4d741afabc4f4093678d95d80a1460fa6")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'http://Linkcents.com')
SHORTENER_API2 = environ.get("SHORTENER_API2", "bf2841e4d741afabc4f4093678d95d80a1460fa6")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'http://Linkcents.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "bf2841e4d741afabc4f4093678d95d80a1460fa6")
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", 'http://Linkcents.com')
...
START_IMG = (environ.get('START_IMG', 'https://envs.sh/Xv6.jpg https://envs.sh/XvV.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://envs.sh/XvV.jpg')).split()
